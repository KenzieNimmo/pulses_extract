...
cd $DB_PATH/$FITS_BASENAME
mkdit fits

python ${SCRIPT_DIR}/pulse_extract.py -pulses_database $DB -pulses_checked $DB_PATH/${FITS_BASENAME}/pulses_list.txt \
  -store_dir $DB_PATH/$FITS_BASENAME/fits -extract_raw $FITS_BASENAME
