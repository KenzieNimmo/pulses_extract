...
python ${SCRIPT_DIR}/pulse_extract.py -fits $FITS -store_events -idL ${FITS_BASENAME} -store_dir $FITS_PATH/$FITS_BASENAME -folder $FITS_PATH/$FITS_BASENAME/TEMP -plot_pulses
