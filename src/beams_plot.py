...
def make_plot(subband):
	...
	ax[8].scatter(300,550,s=10, marker='o', facecolors='none', edgecolors='k')
	ax[8].scatter(300,450,s=40, marker='o', facecolors='none', edgecolors='k')
	ax[8].scatter(300,350,s=200, marker='o', facecolors='none', edgecolors='k')
	ax[8].set_xlim([-1, 600])
	ax[8].set_ylim([-1, 575])
	ax[8].annotate("10 <= S/N < 15", xy=(300, 550), xytext=(50, 550))
	ax[8].annotate("15 < S/N < 40", xy=(300, 450), xytext=(50, 450))
	ax[8].annotate("S/N >= 40", xy=(300, 350), xytext=(50, 350))
